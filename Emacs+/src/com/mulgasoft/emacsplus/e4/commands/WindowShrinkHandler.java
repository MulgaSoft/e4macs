...
/**
 * Shrink window's PartStack if more than one PartStack
 * 
 * @author mfeber - Initial API and implementation
 */
public class WindowShrinkHandler extends E4WindowHandler<WindowShrinkCmd> {

	public WindowShrinkHandler() {
		super(WindowShrinkCmd.class);
	}

	@Override
	protected void addToContext(IEclipseContext ctx) {
		ctx.set(E4CmdHandler.CMD_CTX_KEY, Col.SHRINK);
