...
/**
 * Balance width or height of windows in the selected PartSash
 * 
 * @author mfeber - Initial API and implementation
 */
public class WindowBalanceHandler extends E4WindowHandler<WindowShrinkCmd> {

	public WindowBalanceHandler() {
