 ...
 *
 */
public class ForwardLineHandler extends EmacsOverrunHandler {
	...
	protected int transform(ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		moveWithMark(editor, currentSelection, IEmacsPlusCommandDefinitionIds.LINE_UP, IEmacsPlusCommandDefinitionIds.SELECT_LINE_UP);
		return NO_OFFSET;
	}
