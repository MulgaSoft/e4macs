...
/**
 * Implements: isearch-forward
 *  
 * @author Mark Feber - initial API and implementation
 */
public class ISearchForwardHandler extends MinibufferHandler implements INonEditingCommand {
	...
	protected int transform(final ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		return bufferTransform(new ISearchMinibuffer(), editor, event); 		
	}
	...
	protected String getDispatchId(String checkId, int arg) {
		...
		setUniversalCount(1);
		return com.mulgasoft.emacsplus.IEmacsPlusCommandDefinitionIds.ISEARCH_REGEXP_FORWARD;
	}
}
