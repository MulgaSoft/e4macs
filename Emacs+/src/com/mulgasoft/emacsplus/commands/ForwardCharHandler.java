 ...
 *
 */
public class ForwardCharHandler extends EmacsOverrunHandler {
	...
	protected int transform(ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		this.moveWithMark(editor, currentSelection, IEmacsPlusCommandDefinitionIds.COLUMN_NEXT, IEmacsPlusCommandDefinitionIds.SELECT_COLUMN_NEXT);
		return NO_OFFSET;
	}
