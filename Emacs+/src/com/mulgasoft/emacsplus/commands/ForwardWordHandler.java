 ...
 *
 */
public class ForwardWordHandler extends EmacsOverrunHandler {
	...
	protected int transform(ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		moveWithMark(editor, currentSelection, IEmacsPlusCommandDefinitionIds.WORD_NEXT, IEmacsPlusCommandDefinitionIds.SELECT_WORD_NEXT);
		return NO_OFFSET;
	}
