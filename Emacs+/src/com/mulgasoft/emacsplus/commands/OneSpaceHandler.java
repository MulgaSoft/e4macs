...
/**
 * Implements: just-one-space. Replace all whitespace around point with a single space
 *  
 * @author Mark Feber - initial API and implementation
 */
public class OneSpaceHandler extends WhitespaceHandler {
	...
	protected int transform(ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		return transformSpace(editor, document, currentSelection, SPACE_STR, false);
	}
