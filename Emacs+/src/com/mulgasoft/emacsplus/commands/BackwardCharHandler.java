 ...
 *
 */
public class BackwardCharHandler extends EmacsOverrunHandler {
	...
	protected int transform(ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		this.moveWithMark(editor, currentSelection, IEmacsPlusCommandDefinitionIds.COLUMN_PREVIOUS, IEmacsPlusCommandDefinitionIds.SELECT_COLUMN_PREVIOUS);
		return NO_OFFSET;
	}
