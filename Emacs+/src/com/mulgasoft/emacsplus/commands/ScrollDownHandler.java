 ...
 *
 */
public class ScrollDownHandler extends EmacsOverrunHandler {
	...
	protected int transform(ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		moveWithMark(editor, currentSelection, IEmacsPlusCommandDefinitionIds.PAGE_UP, IEmacsPlusCommandDefinitionIds.SELECT_PAGE_UP);
		return NO_OFFSET;
	}
