 ...
 *
 */
public class BeginOfBufferHandler extends EmacsMovementHandler {
	...
	protected int transform(ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		boolean withSelection = moveWithMark(editor, currentSelection, IEmacsPlusCommandDefinitionIds.TEXT_START, IEmacsPlusCommandDefinitionIds.SELECT_TEXT_START);
		if (!withSelection) {
