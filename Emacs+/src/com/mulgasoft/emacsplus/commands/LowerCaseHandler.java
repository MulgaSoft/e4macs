 ...
 * Convert word/selection to lower case
 *
 * @author Mark Feber - initial API and implementation
 */
public class LowerCaseHandler extends CaseCommandHandler {
	...
	protected int transform(ITextEditor editor, IDocument document, ITextSelection currentSelection, ExecutionEvent event) throws BadLocationException {
		updateText(document,currentSelection, currentSelection.getText().toLowerCase());
