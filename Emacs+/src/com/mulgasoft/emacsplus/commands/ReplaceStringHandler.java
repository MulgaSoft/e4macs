...
/**
 * Implement: replace-string
 * 
 * Read a FROM-STRING and TO-STRING from the minibuffer and
 * replace occurrences of FROM-STRING with TO-STRING.
 * 
 * @author Mark Feber - initial API and implementation
 */
public class ReplaceStringHandler extends MinibufferHandler {
	...
	protected int transform(final ITextEditor editor, IDocument document, ITextSelection currentSelection,
		...
		return bufferTransform(new SearchReplaceMinibuffer(false,true), editor, event); 		
	}
}
